...
SendNexoraNotification("Project Nexora", "Toggle Keybind: ( R )", 30, "rbxassetid://89804924525665")
                ...
                if Gun then
                    if not currentScreenGui then
                        ...
                        if not hasNotifiedSuccess then
                            Notify("Project Nexora", "Gun Detected: Combat Button is now visible.")
                    ...
                    if not hasNotifiedFailure then
                        Notify("Project Nexora", "Ammunition Needed: You need a Gun to use this feature.")
...
Tabs.Main:Input({
    ...
    ["Callback"] = function(Text)
        ...
        if NewSpeed and 0 < NewSpeed then
            FlySpeed = NewSpeed
            SendNexoraNotification("VexonFly", "Speed set to: " .. FlySpeed, 2, "rbxassetid://89804924525665")
        else
            SendNexoraNotification("VexonFly", "Invalid speed. Please enter a number greater than 0.", 3, "rbxassetid://89804924525665")
        end
    end
})
...
local function IsVisible(TargetInstance)
    local TargetPos = TargetInstance:IsA("Player") and TargetInstance.Character and TargetInstance.Character:FindFirstChild("HumanoidRootPart") and TargetInstance.Character.HumanoidRootPart.Position or nil
...
local function SendNotification(Message)
    SendNexoraNotification("Project Nexora", Message, 5, "http://www.roblox.com/asset/?id=89804924525665")
end
